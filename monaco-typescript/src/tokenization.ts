...
export function createTokenizationSupport(language: Language): monaco.languages.TokensProvider {
    ...
    let classifier = ts.createClassifier(),
...
function tokenize(bracketTypeTable: { [i: number]: string }, tokenTypeTable: { [i: number]: string },
    ...
    let result = classifier.getClassificationsForLine(text, state.eolState, true),
        offset = 0;
...
let tsBracketTypeTable: INumberStringDictionary = Object.create(null);
...
let tsTokenTypeTable: INumberStringDictionary = Object.create(null);
...
let jsBracketTypeTable: INumberStringDictionary = Object.create(null);
...
let jsTokenTypeTable: INumberStringDictionary = Object.create(null);
