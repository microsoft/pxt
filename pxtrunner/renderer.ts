...
namespace pxt.runner {
    ...
    function fillWithWidget(
        ...
        if (woptions.showEdit && !theme.hideDocsEdit) { // edit button
            const $editBtn = $('<a class="item" role="button" tabindex="0" aria-label="edit"><i role="presentation" aria-hidden="true" class="edit icon"></i></a>').click(() => {
        ...
        if (options.showJavaScript || !$svg) {
            ...
            // js menu
            if ($svg) {
                const $svgBtn = $('<a class="item blocks" role="button" tabindex="0" aria-label="Blocks"><i role="presentation" aria-hidden="true" class="puzzle icon"></i></a>').click(() => {
                    if ($c.find('.blocks')[0])
        ...
        if (woptions.run && !theme.hideDocsSimulator) {
            let $runBtn = $('<a class="item" role="button" tabindex="0" aria-label="run"><i role="presentation" aria-hidden="true" class="play icon"></i></a>').click(() => {
                if ($c.find('.sim')[0])
        ...
        if (woptions.hexname && woptions.hex) {
            let $hexBtn = $('<a class="item" role="button" tabindex="0" aria-label="download"><i role="presentation" aria-hidden="true" class="download icon"></i></a>').click(() => {
