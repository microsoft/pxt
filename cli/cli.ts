...
function buildSemanticUIAsync(parsed?: commandParser.ParsedCommand) {
    ...
    return nodeutil.spawnAsync({
        cmd: "node",
        args: [lessPath, "theme/style.less", "built/web/semantic.css", "--include-path=node_modules/semantic-ui-less:node_modules/pxt-core/theme:theme/foo/bar", "--no-ie-compat"]
    }).then(() => {
        ...
        return nodeutil.spawnAsync({
            cmd: "node",
            args: [lessPath, "theme/blockly.less", "built/web/blockly.css", "--include-path=node_modules/semantic-ui-less:node_modules/pxt-core/theme:theme/foo/bar", "--no-ie-compat"]
        })
    }).then(() => {
