...
export function serveAsync(parsed: commandParser.ParsedCommand) {
    ...
    return (justServe ? Promise.resolve() : buildAndWatchTargetAsync(includeSourceMaps))
        .then(() => server.serveAsync({
            ...
            addr: parsed.flags["addr"] as string,
            wsPort: parsed.flags["wsport"] as number || 0,
            wsAddr: parsed.flags["wsaddr"] as string,
...
function initCommands() {
    ...
    p.defineCommand({
        ...
        flags: {
            ...
            addr: {
                description: "address to bind server, default 127.0.0.1",
                aliases: ["a"],
                type: "string",
                argument: "addr"
            },
            ...
            wsaddr: {
                description: "address to bind websocket server, default 127.0.0.1",
                type: "string",
                argument: "wsaddr"
            },
