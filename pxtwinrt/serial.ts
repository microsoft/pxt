...
namespace pxtwinrt {
    let watcher: any;
    let ports: pxt.U.Map<DevicePort> = {}
    ...
    export function initSerial() {
        ...
        let filter = new RegExp(pxt.appTarget.serial.nameFilter) || { test: (s) => true };
        let serialDeviceSelector = (Windows.Devices as any).SerialCommunication.SerialDevice.getDeviceSelector();
