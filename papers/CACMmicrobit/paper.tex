...
\begin{itemize}
\item Farnell (hardware manufacturer, packaging and global distribution),
\item Python Software Foundation,
\item MicroPython (Damien George),
\item Bluetooth (Martin Wooley),
\item Tech Will Save Us (graphic design, hardware)
\item Nordic (NRF)
\item NXP (USB interface)
\item many more partners
\end{itemize}
