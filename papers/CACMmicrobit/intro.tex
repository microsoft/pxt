...
(which measures 5.33cm x 6.86cm) and its
...
Low Energy (BLE) communications. A
...
via drag-and-drop operations in web browser.  Text-based coding also was identified as an important feature.
...
would return a final executable to be copied onto a micro:bit (conntected to the host 
