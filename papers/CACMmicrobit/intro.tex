...
Section~\ref{sec:microbit} describes the motivation for and design of the BBC micro:bit .
Section~\ref{sec:projects} presents a sampling of micro:bit projects that
show off the device's capabilities. 
Section~\ref{sec:mef} gives more details about the rollout of the
micro:bit in the UK and around the world, via the partner-based approach
taken by both the BBC and the Foundation. 
