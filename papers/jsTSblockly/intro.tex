...
accidental complexity, due to installation of tool chains and IDEs, which
typically were created with the experienced developer in mind. Today, 
the web has made a plethora of environments for beginning program available 
to anyone with a web browser and internet connection. Most any programming
language can be experienced via the web. Examples
\begin{itemize}
\item JavaScript \url{https://jsfiddle.net/}
\item Python
\end{itemize}
...
Blockly~\cite{Blocky2015} (\url{www.github.com/google/blockly}) 
