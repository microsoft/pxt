...
% Syntactically, many ways to describe object types. STS 
% -	Class type reference
% -	Interface type reference,
% -	array types, tuple types, function types, and constructor types
% -	Object type literal, array type literal, function type literal
% -	Object literals, array literals, function expressions and declarations 
