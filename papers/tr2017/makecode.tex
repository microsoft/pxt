...
combined TypeScript program is within the STS subset through additional syntactic and type checks over the adorned
...
in the \UF format (Section~\ref{sec:uf2}). A third backend generates bytecode instructions.
%The compiler chain
