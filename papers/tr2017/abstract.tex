\begin{abstract}
    ...
    Traditionally, these microcontrollers are programmed in low-level languages, yet given the rise of less traditional application domains, there is a need to simplify the programming of microcontrollers.
