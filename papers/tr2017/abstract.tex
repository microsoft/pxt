\begin{abstract}
    ...
    and Adafruit Circuit Playground Express, popular boards used in making and creating, 
    to the NRF52. We describe how the platform has been architected to 
    make it easy to port to a wide range of microcontollers (\emph{anything}).
\end{abstract}