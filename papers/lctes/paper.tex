\documentclass[sigplan]{acmart}
  ...
  escapeinside={\%*}{*)}          % if you want to add a comment within your code
    ...
    \acmConference[LCTES'18]{Languages, Compilers, Toolchains, and Embedded Systems}{June 19--20}{Philadelphia, PA, USA}

    %% Title information
    \title[Embedded Systems Programming for Education]{\MC and \CO: Intuitive and Efficient Embedded Systems Programming for Education}         %% [Short Title] is optional;
