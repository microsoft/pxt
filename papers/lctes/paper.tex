\documentclass[sigplan]{acmart}
  ...
  escapeinside={\%*}{*)}          % if you want to add a comment within your code
    ...
    \keywords{BBC micro:bit, education, classroom, MakeCode, CODAL, embedded systems}  %% \keywords are mandatory in final camera-ready submission
