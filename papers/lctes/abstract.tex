\begin{abstract}
    ...
    We present the motivation, requirements, implementation and evaluation of a new programming platform that enables novice users to create software for embedded systems. The platform has two major components: Microsoft MakeCode
    (\url{www.makecode.com}), a web app that encapsulates an entire beginner IDE for microcontrollers; CODAL, an efficient component-oriented C++ runtime for microcontrollers. We show how MakeCode and CODAL provide a highly accessible, cross-platform, installation-free programming experience for devices such as the BBC micro:bit and others.
\end{abstract}
