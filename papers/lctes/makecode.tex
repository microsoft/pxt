...
\MC uses the open source Blockly and Monaco editors to allow the user to code with visual blocks or STS. The editing experience is parameterized by the full-typed device runtime, 
...
is used by all SAMD21 targets, including the CPX.
