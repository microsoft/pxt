...
The minimal implementation of the \UF bootloader is \emph{just 1 - 2k bytes of flash memory}, depending on the microcontroller instruction set and USB interfaces.
