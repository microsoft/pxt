...
\url{https://github.com/lancaster-university/codal}.} platform for embedded devices such as the micro:bit that enables the development of embedded applications by non-expert programmers. This platform consists of two major components: 1) Microsoft MakeCode (\url{https://makecode.com}), a web app that consists of a beginner IDE for embedded
