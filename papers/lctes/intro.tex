...
\url{https://github.com/lancaster-university/codal}.} platform for embedded devices such as the micro:bit that enables the development of embedded applications by non-expert programmers. This platform is formed of two major components: 1) Microsoft MakeCode (\url{https://makecode.com}), a web app that consists of a beginner IDE for embedded systems; and 2) CODAL (Component-Oriented Device Abstraction Layer), an efficient C++ runtime with high-level programming abstractions.
