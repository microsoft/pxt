...
the simplified programming of MCUs via editors for visual blocks and the textual TypeScript\footnote{\url{https://www.typescriptlang.org}} language.
CODAL, a component-oriented, event-dri\-ven, fiber-based C++ runtime environment that bridges the semantic gap between the higher-level languages (such
