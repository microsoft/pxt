...
namespace pxtblockly {
    ...
    export class FieldPosition extends Blockly.FieldSlider implements Blockly.FieldCustom {
        ...
        private static eyedropperActivated_: boolean;
        ...
        private activeEyedropper_() {
            ...
            if (FieldPosition.eyedropperActivated_) return;
            FieldPosition.eyedropperActivated_ = true;
        ...
        private close(skipWidget?: boolean) {
            ...
            FieldPosition.eyedropperActivated_ = false;
        }
    }
