...
import { Program, SyntaxKind, Declaration, TypeFlags, ParameterDeclaration, Expression, PropertyAccessExpression, ImportEqualsDeclaration, Type, isStringLiteral } from "../ext-typescript/lib/typescript";
import { pxtInfo, PxtNodeFlags, SK, isStringType, pxtcTarget, isStatic, isCtorField, CallInfo, getNodeFullName, checkType } from "./emitter";
...
export function annotate(
    program: Program,
    entryPoint: string,
    compileTarget: ts.pxtc.CompileTarget) {

    const oldTarget = pxtcTarget;
    pxtcTarget = compileTarget;
