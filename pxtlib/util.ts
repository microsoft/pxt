...
namespace ts.pxtc.Util {
    ...
    export const allLanguages: pxt.Map<Language> = {
        ...
        "fil": {englishName: "Filipino", localizedName: "Wikang Filipino"},
        "fo": {englishName: "Faroese", localizedName: "føroyskt mál"},
        ...
        "ka": {englishName: "Georgian", localizedName: "ქართული ენა"},
        "kab": { englishName: "Kabyle", localizedName: "شئعم" },
        "kk": {englishName: "Kazakh", localizedName: "қазақша"},
        "km": {englishName: "Khmer", localizedName: "ភាសាខ្មែរ"},
        ...
        "ku": {englishName: "Kurdish", localizedName: "Kurdî"},
        ...
        "ms": {englishName: "Malay", localizedName: "Bahasa Melayu"},
        ...
        "sat": {englishName: "Santali", localizedName: "ᱥᱟᱱᱛᱟᱲᱤ"},
        ...
        "zh-HK": {englishName: "Chinese (Traditional, Hong Kong)", localizedName: "中文(繁體, 香港)"},
