...
// populateArgument_: function (this: FunctionDefinitionBlock, arg: FunctionArgument, connectionMap: ConnectionMap, input: Blockly.Input) {

// },

// addFunctionLabel_: function (this: FunctionDefinitionBlock, text: string) {
...
// updateLabelEditor_: function (this: FunctionDefinitionBlock, text: string) {
//     Blockly.Events.disable();
//     this.getField('function_name')!.setValue(text);
//     Blockly.Events.enable();
// },

// updateLabelField_: function (this: FunctionDefinitionBlock, text: string) {
//     this.getField('function_name')!.setValue(text);
// },

// addLabelEditor_: function (this: FunctionDefinitionBlock, text: string) {
//     let nameField;
//     if (this.type === FUNCTION_DEFINITION_BLOCK_TYPE) {
//         nameField = new Blockly.FieldTextInput(text || '', Blockly.Functions.rename);
//     } else {
//         nameField = new Blockly.FieldTextInput(text || '');
//     }
...
// addLabelField_: function (this: FunctionDefinitionBlock, text: string) {
//     this.appendDummyInput('function_name').appendField(new Blockly.FieldLabel(text, 'functionNameText'), 'function_name');
// },

// attachShadow_: function (this: FunctionDefinitionBlock, input: Blockly.Input, argumentType: string) {
//     let shadowInfo = Blockly.PXTBlockly.FunctionUtils.getShadowBlockInfoFromType_(
//         argumentType, this.workspace);
//     let shadowType = shadowInfo[0];
//     let fieldName = shadowInfo[1];
//     let fieldValue = shadowInfo[2];
//     Blockly.Events.disable();
//     let newBlock = null;
//     try {
...
// buildShadowDom_: function (this: FunctionDefinitionBlock, argumentType: string) {
//     let shadowDom = Blockly.utils.xml.createElement('shadow');
//     let shadowInfo = Blockly.PXTBlockly.FunctionUtils.getShadowBlockInfoFromType_(
//         argumentType, this.workspace);
//     let shadowType = shadowInfo[0];
//     let fieldName = shadowInfo[1];
//     let fieldValue = shadowInfo[2];
//     let isVarGet = shadowType === "variables_get";
//     shadowDom.setAttribute('type', shadowType);
//     let fieldDom = goog.dom.createDom('field', null, fieldValue);
//     if (isVarGet) {
//         fieldDom.setAttribute("id", fieldValue);
//         let varModel = this.workspace.getVariableById(fieldValue);
...
// onchange: function (this: FunctionDefinitionBlock) {
