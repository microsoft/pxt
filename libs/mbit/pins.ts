...
namespace pins {
    ...
    //% blockId=device_set_digital_pin block="digital write |%value|to pin %name"
     ...
     * @param name pin to write to
     */
    //% help=functions/analog-read-pin weight=47 shim=micro_bit::analogReadPin
     ...
     */
    //% help=functions/analog-write-pin weight=46 shim=micro_bit::analogWritePin
    //% blockId=device_set_analog_pin block="analog write|%value|to pin %name" blockGap=8
     ...
     */
    //% shim=micro_bit::setAnalogPeriodUs help=functions/analog-set-period weight=45
    //% blockId=device_set_analog_period block="device_set_analog_period|(µs)%micros|to pin %pin" 
     ...
     */
    //% help=functions/servo-write-pin weight=44 shim=micro_bit::servoWritePin
    //% blockId=device_set_servo_pin block="servo write|%value|to pin %name" blockGap=8
     ...
     */
    //% shim=micro_bit::setServoPulseUs help=functions/serial-set-pulse weight=43
    //% blockId=device_set_servo_pulse block="servo set pulse|(µs)%micros|to pin %value"
    ...
    //% blockId=math_map block="map|from low %fromLow|from high %fromHigh|to low %toLow|to high %toHigh"
