...
namespace devices {
     ...
     * @param event TODO
     */
    //% weight=19 help=functions/tell-camera-to shim=micro_bit::devices::camera
    //% blockId=devices_camera icon="\uf030" block="tell camera to|%NAME" blockGap=8
     ...
     * @param event TODO
     */
    //% weight=18 help=functions/raise-alert-to shim=micro_bit::devices::alert
