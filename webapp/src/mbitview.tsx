        ...
        return (
            <svg version="1.1" x="0px" y="0px" viewBox="0 0 498 406" enable-background="new 0 0 498 406">
                <g>
                    ...
                    <path className="sim-pin" fill={this.props.theme.pin} d="M483.6,402c8.2-5,14.4-14.4,14.4-25.1v-19.2h-14.4V402z"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="66.7" y="356.7" width="9.2" height="49.3"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="79.1" y="356.7" width="9.2" height="49.3"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="91.4" y="356.7" width="9.2" height="49.3"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="103.7" y="356.7" width="9.2" height="49.3"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="164.3" y="356.7" width="10.3" height="49.3"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="176.6" y="356.7" width="10.3" height="49.3"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="188.9" y="356.7" width="10.3" height="49.3"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="201.3" y="356.7" width="10.3" height="49.3"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="213.6" y="356.7" width="10.3" height="49.3"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="275.2" y="356.7" width="9.2" height="49.3"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="287.5" y="356.7" width="9.2" height="49.3"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="299.8" y="356.7" width="9.2" height="49.3"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="312.1" y="356.7" width="9.2" height="49.3"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="324.5" y="356.7" width="9.2" height="49.3"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="385.1" y="356.7" width="10.3" height="49.3"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="397.4" y="356.7" width="10.3" height="49.3"/>
                    <rect className="sim-pin" fill={this.props.theme.pin} x="409.7" y="356.7" width="10.3" height="49.3"/>
                    ...
                    <polygon className="sim-theme" fill={this.props.theme.accent} points="173,27.9 202.5,0 173,0 		"/>
                    ...
                    <polygon className="sim-theme" fill={this.props.theme.accent} points="54.1,242.4 54.1,274.1 22.4,274.1 	"/>
                    <path d="M48.1,270.9l-0.6-1.7h-5.1l-0.6,1.7h-3.5l5.1-14.3h3.1l5.2,14.3H48.1z M45,260.7l-1.8,5.9h3.5L45,260.7z"/>
                    <polygon className="sim-theme" fill={this.props.theme.accent} points="446.2,164.6 446.2,132.8 477.9,132.8 	"/>
                    ...
                    <path className="sim-theme" fill={this.props.theme.accent} d="M230.6,69.7c-2.9,0-5.3,2.4-5.3,5.3c0,2.9,2.4,5.3,5.3,5.3c2.9,0,5.3-2.4,5.3-5.3C235.9,72.1,233.5,69.7,230.6,69.7"/>
