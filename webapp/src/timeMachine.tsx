...
import HistoryFile = pxt.editor.HistoryFile;
import applySnapshot = pxt.editor.applySnapshot;
import patchConfigEditorVersion = pxt.editor.patchConfigEditorVersion;
