        ...
        return (
            <div className="image-editor-topbar">
                ...
                <div className="image-transform-group">
                    <IconButton key="flipv" iconClass="xicon flipvertical" title={lf("Flip image vertical")} onClick={this.flipVertical} />
                    <IconButton key="fliph" iconClass="xicon fliphorizontal" title={lf("Flip image horizontal")} onClick={this.flipHorizontal} />
                    <IconButton key="rotatec" iconClass="xicon rotateright" title={lf("Rotate image clockwise")} onClick={this.rotateClockwise} />
                    <IconButton key="rotatecc" iconClass="xicon rotateleft" title={lf("Rotate image counterclockwise")} onClick={this.rotateCounterclockwise} />
                </div>
