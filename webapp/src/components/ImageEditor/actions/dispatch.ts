...
export const dispatchSetInitialTilemap = (tilemap: pxt.sprite.Tilemap, tileset: pxt.sprite.TileSet, gallery: GalleryTile[], layers: pxt.sprite.BitmapData[]) => ({ type: actions.SET_INITIAL_TILEMAP, tilemap, tileset, layers, gallery });
