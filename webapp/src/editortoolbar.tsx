...
export class EditorToolbar extends data.Component<ISettingsProps, {}> {
    ...
    private getSaveInput(view: View, showSave: boolean, id?: string, projectName?: string): JSX.Element[] {
        ...
        const showGithubButton = pxt.appTarget.cloud
                            ...
                            <div className="ui grid right aligned">
                                ...
                                {showProjectRename &&
                                    <div className="ui row items" style={compileBtn ? { paddingTop: 0, marginTop: 0 } : {}}>
                                        {hasRepository
                                            ? <githubbutton.GithubButton parent={this.props.parent} key={`githubbtn${tablet}`} />
                ...
                <div className="ui grid equal width">
                    ...
                    {showProjectRename &&
                        <div id="projectNameArea" className="column left aligned">
                            {hasRepository
                                ? <githubbutton.GithubButton parent={this.props.parent} key={`githubbtn${computer}`} />
