...
export class EditorToolbar extends data.Component<ISettingsProps, {}> {
    ...
    render() {
        ...
        const downloadIcon = pxt.appTarget.appTheme.useUploadMessage ? "upload" : {downloadIcon};
        const downloadText = pxt.appTarget.appTheme.useUploadMessage ? lf("Upload") : lf({downloadIcon});
