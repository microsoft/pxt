...
export class DocsMenuItem extends data.Component<ISettingsProps, {}> {
    ...
    render() {
        ...
        return <sui.DropdownMenuItem icon="help circle large" class="help-dropdown-menuitem" textClass={"landscape only"} tabIndex={this.props.tabIndex} title={lf("Reference, lessons, ...") }>
