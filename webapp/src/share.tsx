...
export class ShareEditor extends data.Component<ShareEditorProps, ShareEditorState> {
    ...
    renderCore() {
        ...
        const canScreenshot = targetTheme.simScreenshot;
                    ...
                    {action && this.loanedSimulator ? <div className="ui fields">
                        ...
                        <div className="ui ten wide field">
                            ...
                            <div className="ui buttons landscape only">
                                ...
                                {canScreenshot ? <sui.Button icon="camera" title={screenshotText} ariaLabel={screenshotText} onClick={this.handleScreenshotClick} disabled={screenshotDisabled} /> : undefined}
