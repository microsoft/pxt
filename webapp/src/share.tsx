                ...
                <div className={`ui form`}>
                    ...
                    { url && ready ? <div>
                        ...
                        {showSocialIcons ? <div className="social-icons">
                            <a className="ui button large icon facebook" onClick={(e) => { showFbPopup(); e.preventDefault(); return false; }} tabIndex={0} onKeyDown={sui.fireClickOnEnter}><i className="icon facebook"></i></a>
                            <a className="ui button large icon twitter" onClick={(e) => { showTwtPopup(); e.preventDefault(); return false; }} tabIndex={0} onKeyDown={sui.fireClickOnEnter}><i className="icon twitter"></i></a>
                        </div> : undefined}
                    </div>
                        : undefined }
                    { ready ? <div>
