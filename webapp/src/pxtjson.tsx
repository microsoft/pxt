...
*/
    ...
    menu() {
        return (<sui.Button class="button floating" text={lf("Back to Code") } icon={this.parent.state.header.editor == pxt.BLOCKS_PROJECT_NAME ? "puzzle" : "align left"} onClick={() => this.parent.setFile(pkg.mainEditorPkg().getMainFile()) } />)
    }
}
