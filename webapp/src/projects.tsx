    ...
    renderCore() {
        ...
        return (
            <sui.Modal open={visible} className="projectsdialog" size="fullscreen" closeIcon={false}
                        ...
                        <div className="group ten wide column">
                            <div className="ui cards centered">
                                {this.state.resumeProject ? <codecard.CodeCardView
                                    ariaLabel={lf("Load the last project you worked on")}
                                    role="button"
                                    key={'resume'}
                                    iconColor="teal"
                                ...
                                {pxt.appTarget.appTheme.sideDoc ? <codecard.CodeCardView
                                    ariaLabel={lf("Create a fun, beginner project in a guided tutorial")}
                                    role="button"
                                    key={'gettingstarted'}
                                    iconColor="green"
                                ...
                                <codecard.CodeCardView
                                    ariaLabel={lf("Start a new, empty project")}
                                    role="button"
                                    key={'newproject'}
                                    iconColor="brown"
                                    ...
                                    />
                                <codecard.CodeCardView
                                    ariaLabel={lf("Load a previous project")}
                                    role="button"
                                    key={'loadproject'}
                                    iconColor="grey"
                                ...
                                {galleryNames.length > 0 ? <codecard.CodeCardView
                                    ariaLabel={lf("Browse guided tutorials, project samples and awesome activities")}
                                    role="button"
                ...
                {tab != MYSTUFF && tab != WELCOME ? <div id={`tab${tab}`} role="tabpanel" aria-labelledby={`${tab}tab`} aria-hidden="false" className={tabClasses}>
                    {hadFetchError ?
