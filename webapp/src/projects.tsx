        ...
        return <div ref="homeContainer" className={tabClasses}>
            {showHeroBanner ?
                <div className="ui segment getting-started-segment" style={{ backgroundImage: `url(${encodeURI(targetTheme.homeScreenHero)})` }}>
                    <sui.Link key="followtwitter" icon="twitter" class="button mini home-follow" textClass="landscape only" text={lf("Follow @MsMakeCode")} title={lf("Follow us on Twitter for updates!")} href="https://twitter.com/intent/follow?screen_name=@MsMakeCode" target="_blank" />
                </div> : undefined}
