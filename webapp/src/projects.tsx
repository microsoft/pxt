           ...
           return <div className="ui grid stackable padded">
                ...
                <div className="column twelve wide">
                    <div className="segment">
                        ...
                        <iframe width='100%' height='90%' src={`https://www.youtube-nocookie.com/embed/${youTubeId}`} frameBorder='0' allowFullScreen style={{display: 'block', position: 'absolute', top: '5%'}} sandbox></iframe>
                    </div>
                </div>
            </div>;
        else
