        ...
        return (
            <div id='root' className={rootClasses}>
                ...
                {sandbox ? <div className="ui horizontal small divided link list sandboxfooter">
                    ...
                    <span className="item"><a className="ui thin portrait only" title={compileTooltip} onClick={() => this.compile() }><i className={`icon ${ pxt.appTarget.appTheme.useUploadMessage ? 'upload' : 'download`}}/>{ pxt.appTarget.appTheme.useUploadMessage ? lf("Upload") : lf("Download") }</a></span>
                </div> : undefined}
