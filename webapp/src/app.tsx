...
export class ProjectView
    ...
    startActivity(activity: pxt.editor.Activity, path: string, title?: string, editorProjectName?: string, focus?: boolean) {
        ...
        this.textEditor.giveFocusOnLoading = (focus === undefined ? true : focus);
    }
