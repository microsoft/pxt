...
Certain targets (such as [MakeCode Arcade](https://arcade.makecode.com)) can include resource files inside of projects. The resoures, or _assets_, might contain byte respresentations of images, animations, sounds, tilemaps, etc.
