...
- Locale code is **case sensitive**. Please find the exact locale code from the list in: https://github.com/microsoft/pxt-microbit/blob/master/pxtarget.json#L476 
