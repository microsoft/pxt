...
Create a new project from the home screen. Click on the **GitHub** button next to the **Save Project**
window and button. You'll then be prompted to sign in to GitHub (if you don't already have a GitHub account,
you can create one by clicking the link on the sign in page).
