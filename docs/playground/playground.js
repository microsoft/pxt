...
(function () {
    ...
    function load() {
        ...
        function loadSample(sampleId, callback) {
            ...
            samplePath = 'playground/samples/' + samplePath;
    ...
    function doRun(runContainer) {
        ...
        var commonPromise = xhr("./playground/pxt-common/pxt-core.d.ts")
            .then(function (response) { return response.responseText });

        var helperPromise = xhr("./playground/pxt-common/pxt-helpers.ts")
            .then(function (response) { return response.responseText });
