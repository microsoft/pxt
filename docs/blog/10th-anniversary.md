...
![Teacher and classroom with micro:bit](/static/blog/10th-anniversary/microbit-teacher.jpg)
...
The mission of Microsoft MakeCode is to inspire new generations of technology creators.  We are incredibly proud of the impact MakeCode has had on the lives of young people around the world.
...
It's about the teacher who spends the extra time prepping for a physical computing activity to engage a student who never thought coding was for them.
...
>_The other thing I learned while using MakeCode was JavaScript. Writing code in blocks, switching to the JavaScript editor, and looking at what the block code turned into was a big step in learning JavaScript and written code in general. Reading the JavaScript code running behind each block helped me better solve peoples' block code issues too, and now I also make extensions!_
