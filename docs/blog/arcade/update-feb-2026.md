...
![Tilemap](/static/blog/arcade/update-feb-2026/tilemap.png)
...
* [Character Animations](https://arcade.makecode.com/pkg/microsoft/arcade-character-animations) – this extension provides fine-grain control over when animations run on a sprite. For example, you can create specific animations for when your sprite is moving or facing certain directions.
