...
![Tokyo Night](/static/blog/arcade/update-aug-2026/tokyo-night.png)
...
![Simulator Theme](/static/blog/arcade/update-aug-2026/sim-theme.png)
...
![Share Project](/static/blog/arcade/update-aug-2026/sim-theme-share.png)

![Shared Game](/static/blog/arcade/update-aug-2026/game-share.png)
...
![Project Settings](/static/blog/arcade/update-aug-2026/project-settings.png)
...
The most common screen readers, including NVDA, JAWS, Windows Narrator, Mac Voice Over, and ChromeVox are also supported for block-based programming. Simply turn on your preferred screen reader and navigate around the MakeCode user interface to hear descriptions and actions you can take. 
...
For those of you using extensions in your projects, we’ve made the **Extensions Gallery** a bit easier to use by adding a label for currently installed extensions (we just removed them before) and allowing you to manage installed extensions (update, delete).
