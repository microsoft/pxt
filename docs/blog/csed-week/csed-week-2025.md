...
**Posted on November 12th, 2025 by [Jaqster](https://github.com/jaqster)**

[Computer Science Education Week](https://www.csedweek.org) is the time every year where schools all across the country shine a light on the importance of computing and technical education. As Artificial Intelligence (AI) is an important part of computer science, the theme for this year is how CS Powers AI Innovation. As a result, we are encouraging everyone to do an [Hour of AI](https://csforall.org/hour-of-ai) for CS Education Week this year.
...
Activity: https://aka.ms/ba Educator Resources: https://aka.ms/ba-edu

Minecraft Education First Night

Surviving your first night in Minecraft is a classic challenge. But what if you had an AI partner to help you? “The First Night” turns a classic first-night setup into a safety-by-design challenge, available as a free demo in Minecraft Education. With an AI helper, you’ll plan, prototype, and automate Minecraft tasks while learning how to code in Blocks and Python and how agentic AI can be used. Can you build shelter before the sun sets? Join Hour of AI today!

<MinecraftFirstNight.png>
...
Activity: https://aka.ms/slither Educator Resources: https://aka.ms/slither-slam-educator
