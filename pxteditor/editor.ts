namespace pxt.editor {
    ...
    let initEditorExtensionsPromise: Promise<void>;
    export function initEditorExtensionsAsync(): Promise<void> {
        if (!initEditorExtensionsPromise) {
            initEditorExtensionsPromise = Promise.resolve();
            if (pxt.appTarget && pxt.appTarget.appTheme && pxt.appTarget.appTheme.extendFieldEditors) {
                ...
                initEditorExtensionsPromise = initEditorExtensionsPromise
        ...
        return initEditorExtensionsPromise;
    }
}
